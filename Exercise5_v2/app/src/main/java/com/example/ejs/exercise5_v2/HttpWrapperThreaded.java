...
public class HttpWrapperThreaded {
    ...
    private GuessingActivity activity2;
    ...
    public HttpWrapperThreaded(GuessingActivity activity2, String urlToServer, int activitynr){
    ...
    public HttpWrapperThreaded(MainActivity activity, String urlToServer, int activitynr){
    ...
    private class RequestThread extends AsyncTask<Map<String, String>,String,String> {
        ...
        protected String doInBackground(Map<String,String>... v){
            //System.out.println("requestthread:"+v[0]);
            try{
        ...
        protected void onPostExecute(String response){
            if (activitynr == 1){
                ...
                activity2.showResponse(response);
            }
    ...
    public String httpGetWithHeader(Map<String,String> parameterList) throws IOException {
        ...
        URLConnection connection = new URL(url).openConnection();
        connection.setRequestProperty("Accept-Charset", ENCODING);
        connection.setRequestProperty("Set-Cookie", "name1=value1; name2=value2");
